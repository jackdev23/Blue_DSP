#ifndef F350_750APF_H
#define F450_750APF_H

extern FIRFilterStructure f450_750apfFilter;
...

{
   ...
   FIRFilterInit( &f450_750apfFilter );
   ...
   BlockFIRFilter( &f450_750apfFilter, &inSamples, &outSamples, NUM_SAMPLES );
}
*/
